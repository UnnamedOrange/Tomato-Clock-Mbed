...
public:
     ...
     *
     * @param command Complete AT command.
     * @param timeout The time to wait for the reply. You should set it to an estimated value. The default value is
     * 1000ms.
     * @return std::string The reply in string.
     */
    std::string write_and_get_reply(const std::string_view command,
                                    std::chrono::milliseconds timeout = _default_reply_timeout) {
